...
hips: hip/hip_main.cpp hip/hip_ui.cpp hip/hip_logic.cpp hip/hip_ui.h hip/hip_logic.h hip/hip_shared.h
	$(CXX) $(CXXFLAGS) hip/hip_main.cpp hip/hip_ui.cpp hip/hip_logic.cpp -o hips -lncurses -lrt
